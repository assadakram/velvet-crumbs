export const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    navStory: "Our Story",
    navMenu: "Our Treats",
    navStuffedCookies: "Stuffed Cookies",
    navBrownies: "Brownies",
    navOrder: "Order",
    ...
    promoFreeDel: "FREE DELIVERY on orders over 24.99 € in local service areas!",
    ...
    tabCookies: "Stuffed Cookies",
    tabBrownies: "Brownies",
    tabBoxes: "Assorted Boxes",
    keyIngredients: "Ingredients",
    orderTag: "Request Fresh Baking",
    orderTitle: "Pre-order Request",
    orderPromo: "🎁 Orders over 24.99 € → FREE delivery in Turku, Raisio & Kaarina!",
    ...
    navStory: "Tarinamme",
    navMenu: "Herkkumme",
    navStuffedCookies: "Täytekeksit",
    navBrownies: "Browniet",
    navOrder: "Tilaus",
    ...
    promoFreeDel: "ILMAINEN TOIMITUS yli 24,99 € tilauksille lähialueillamme!",
    ...
    tabCookies: "Täytekeksit",
    tabBrownies: "Browniet",
    tabBoxes: "Lajitelmaboksit",
    keyIngredients: "Ingredients",
    orderTag: "Tee Tilaus",
    orderTitle: "Tilauskysely",
    orderPromo: "🎁 Yli 24,99 € tilaukset → ILMAINEN kotiinkuljetus Turussa, Raisiossa & Kaarinassa!",
