export const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    promoFreeDel: "FREE DELIVERY on orders over 25 € in local service areas!",
    ...
    orderPromo: "🎁 Orders over 25 € → FREE delivery in Turku, Raisio & Kaarina!",
    ...
    promoFreeDel: "ILMAINEN TOIMITUS yli 25 € tilauksille lähialueillamme!",
    ...
    orderPromo: "🎁 Yli 25 € tilaukset → ILMAINEN kotiinkuljetus Turussa, Raisiossa & Kaarinassa!",
